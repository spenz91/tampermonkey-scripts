...
(NOW(), '1', '0', 'U01', 'Plugin Dixell 01', 'dixell_xlr130', 'DIXELL', '0_1', 'DIXELL', 'DIXELL', 0, ''),
(NOW(), '1', '0', 'U02', 'Plugin Dixell 02', 'dixell_xlr130', 'DIXELL', '0_2', 'DIXELL', 'DIXELL', 0, ''),
(NOW(), '1', '0', 'U03', 'Plugin Dixell 03', 'dixell_xlr130', 'DIXELL', '0_3', 'DIXELL', 'DIXELL', 0, ''),
(NOW(), '1', '0', 'U04', 'Plugin Dixell 04', 'dixell_xlr130', 'DIXELL', '0_4', 'DIXELL', 'DIXELL', 0, ''),
(NOW(), '1', '0', 'U05', 'Plugin Dixell 05', 'dixell_xlr130', 'DIXELL', '0_5', 'DIXELL', 'DIXELL', 0, ''),
(NOW(), '1', '0', 'U06', 'Plugin Dixell 06', 'dixell_xlr130', 'DIXELL', '0_6', 'DIXELL', 'DIXELL', 0, ''),
(NOW(), '1', '0', 'U07', 'Plugin Dixell 07', 'dixell_xlr130', 'DIXELL', '0_7', 'DIXELL', 'DIXELL', 0, ''),
(NOW(), '1', '0', 'U08', 'Plugin Dixell 08', 'dixell_xlr130', 'DIXELL', '0_8', 'DIXELL', 'DIXELL', 0, ''),
(NOW(), '1', '0', 'U09', 'Plugin Dixell 09', 'dixell_xlr130', 'DIXELL', '0_9', 'DIXELL', 'DIXELL', 0, ''),
(NOW(), '1', '0', 'U10', 'Plugin Dixell 10', 'dixell_xlr130', 'DIXELL', '0_10', 'DIXELL', 'DIXELL', 0, '');
...
(NOW(), 'DIXELL', 'dixell_xlr130_param', 'dixell_xlr130_groups');

CREATE TABLE IF NOT EXISTS `iw_par_dixell_xlr130_groups` (
...
REPLACE INTO `iw_par_dixell_xlr130_groups` (`row_date`, `type`, `view_order`, `ref`, `value`) VALUES
(NOW(), 'default_link', 1, '', ''),
...
CREATE TABLE IF NOT EXISTS `iw_par_dixell_xlr130_param` (
...
REPLACE INTO `iw_par_dixell_xlr130_param` (`row_date`, `element_id`, `driver_id`, `alias_text`, `menu`, `application`, `parameter_type`, `factory_setting`, `grp`, `att`, `eng_unit`, `format`, `range_min`, `range_max`, `scale`, `raw_min`, `raw_max`, `eng_min`, `eng_max`, `driver_id_extra`, `format_extra`) VALUES
...
CREATE TABLE IF NOT EXISTS `iw_set_dixell_xlr130` (
  `row_date` datetime NOT NULL DEFAULT '2004-01-10 00:00:00',
  `element_id` varchar(100) NOT NULL DEFAULT '',
...
REPLACE INTO `iw_set_dixell_xlr130` (`row_date`, `element_id`, `active`, `onl_ind`, `update_freq`, `save_data`, `save_freq`, `plant_pri`, `sys_pri`, `alarm_type`) VALUES
