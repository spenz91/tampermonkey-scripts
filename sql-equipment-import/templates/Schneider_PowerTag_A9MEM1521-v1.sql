...
(NOW(), '1', '0', 'E01', 'Q00 Kurs 01', 'powertag_a9mem152x', 'POWERTAG', '1_150', 'A9MEM1521', 'A9MEM152X', 0, ''),
(NOW(), '1', '0', 'E02', 'Q00 Kurs 02', 'powertag_a9mem152x', 'POWERTAG', '1_151', 'A9MEM1521', 'A9MEM152X', 0, ''),
(NOW(), '1', '0', 'E03', 'Q00 Kurs 03', 'powertag_a9mem152x', 'POWERTAG', '1_152', 'A9MEM1521', 'A9MEM152X', 0, ''),
(NOW(), '1', '0', 'E04', 'Q00 Kurs 04', 'powertag_a9mem152x', 'POWERTAG', '1_153', 'A9MEM1521', 'A9MEM152X', 0, ''),
(NOW(), '1', '0', 'E05', 'Q00 Kurs 05', 'powertag_a9mem152x', 'POWERTAG', '1_154', 'A9MEM1521', 'A9MEM152X', 0, ''),
(NOW(), '1', '0', 'E06', 'Q00 Kurs 06', 'powertag_a9mem152x', 'POWERTAG', '1_155', 'A9MEM1521', 'A9MEM152X', 0, ''),
(NOW(), '1', '0', 'E07', 'Q00 Kurs 07', 'powertag_a9mem152x', 'POWERTAG', '1_156', 'A9MEM1521', 'A9MEM152X', 0, '');
(NOW(), '1', '0', 'E08', 'Q00 Kurs 08', 'powertag_a9mem152x', 'POWERTAG', '1_157', 'A9MEM1521', 'A9MEM152X', 0, ''),
(NOW(), '1', '0', 'E09', 'Q00 Kurs 09', 'powertag_a9mem152x', 'POWERTAG', '1_158', 'A9MEM1521', 'A9MEM152X', 0, ''),
(NOW(), '1', '0', 'E10', 'Q00 Kurs 10', 'powertag_a9mem152x', 'POWERTAG', '1_159', 'A9MEM1521', 'A9MEM152X', 0, '');
...
(NOW(), 'A9MEM152X', 'powertag_a9mem152x_param', 'powertag_a9mem152x_groups');

CREATE TABLE IF NOT EXISTS `iw_par_powertag_a9mem152x_groups` (
...
REPLACE INTO `iw_par_powertag_a9mem152x_groups` (`row_date`, `type`, `view_order`, `ref`, `value`) VALUES
(NOW(), 'default_link', 1, '', ''),
...
(NOW(), 'group', 2, 'Measurement', 'Measurement_0_3_3027'),
(NOW(), 'group', 3, 'Measurement', 'Measurement_0_3_3053'),
(NOW(), 'group', 4, 'Measurement', 'Measurement_0_3_3059'),
(NOW(), 'group', 5, 'Measurement', 'Measurement_0_3_3083'),
(NOW(), 'group', 6, 'Measurement', 'Measurement_0_3_3203'),
(NOW(), 'group', 7, 'Measurement', 'Measurement_0_3_3255'),
(NOW(), 'group', 8, 'Measurement', 'Measurement_0_3_3259'),
(NOW(), 'group', 9, 'Measurement', 'Measurement_0_3_3299.0'),
(NOW(), 'group', 10, 'Measurement', 'Measurement_0_3_3299.1'),
(NOW(), 'group', 11, 'Measurement', 'Measurement_0_3_3301'),
(NOW(), 'group', 1, 'Configuration', 'Configuration_0_3_31024');

CREATE TABLE IF NOT EXISTS `iw_par_powertag_a9mem152x_param` (
...
REPLACE INTO `iw_par_powertag_a9mem152x_param` (`row_date`, `element_id`, `driver_id`, `alias_text`, `menu`, `application`, `parameter_type`, `factory_setting`, `grp`, `att`, `eng_unit`, `format`, `range_min`, `range_max`, `scale`, `raw_min`, `raw_max`, `eng_min`, `eng_max`, `driver_id_extra`, `format_extra`) VALUES
...
(NOW(), 'Measurement_0_3_3299', '0_3_3299', 'Status', '', 'Integral values', 'integer', '', '-1', 'r', '', '', '', '', '', '', '', '', '', '3_3299_I32_N_-_-_-_-', ''),
...
(NOW(), 'Configuration_0_3_31024', '0_3_31024', 'Product type of wireless devices', '', 'Integral values', 'integer', '', '-1', 'r', '', '', '', '', '', '', '', '', '', '3_31024_I16_N_-_-_-_-', '{"rev":"1","type":"num","v":{"41":{"t":"1P"},"42":{"t":"1P+N Up"},"43":{"t":"1P+N Down"},"44":{"t":"3P"},"45":{"t":"3P+N Up"},"45":{"t":"3P+N Down"}}}');

CREATE TABLE IF NOT EXISTS `iw_set_powertag_a9mem152x` (
  `row_date` datetime NOT NULL DEFAULT '2004-01-10 00:00:00',
  `element_id` varchar(100) NOT NULL DEFAULT '',
...
REPLACE INTO `iw_set_powertag_a9mem152x` (`row_date`, `element_id`, `active`, `onl_ind`, `update_freq`, `save_data`, `save_freq`, `plant_pri`, `sys_pri`, `alarm_type`) VALUES
(NOW(), 'Measurement_0_3_2999', '1', '1', 'norm', 'min', '1', '', '', 0),
(NOW(), 'Measurement_0_3_3027', '1', '1', 'norm', 'min', '1', '', '', 0),
(NOW(), 'Measurement_0_3_3053', '1', '1', 'norm', 'min', '1', '', '', 0),
(NOW(), 'Measurement_0_3_3059', '1', '1', 'norm', 'min', '1', '', '', 0),
